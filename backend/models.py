from sqlalchemy import Column, Integer, String, Float, DateTime, Date, Boolean, ForeignKey, Text, Enum as SQLEnum, Index
...
class TimeEntry(Base):
    ...
    __table_args__ = (
        Index("ix_time_entries_owner_work_date", "owner_id", "work_date"),
